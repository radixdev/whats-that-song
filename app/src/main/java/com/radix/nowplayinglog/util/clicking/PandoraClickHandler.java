...
public class PandoraClickHandler implements ISongClickHandler {
  private static final String TAG = PandoraClickHandler.class.getName();
  ...
  public void handlePlaySongClick(Context context, Song song) {
    ...
    intent.setComponent(new ComponentName(
        "com.pandora.android",
        "com.pandora.android.activity.CreateStationApiActivity"));
