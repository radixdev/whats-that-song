...
public class SoundcloudClickHandler implements ISongClickHandler {
  private static final String TAG = SoundcloudClickHandler.class.getName();
  ...
  public void handlePlaySongClick(Context context, Song song) {
    ...
    intent.setComponent(new ComponentName(
        ...
        "com.soundcloud.android.search.PlayFromVoiceSearchActivity"));
